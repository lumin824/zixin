...
CREATE TABLE IF NOT EXISTS `zixin`.`company` (
  ...
  `establish_date` VARCHAR(255) NULL,
  `industry` VARCHAR(255) NULL,
  `legal_person` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `zixin`.`user_req_company_source` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_user_req_company_source__user_req_id`
    FOREIGN KEY (`user_req_id`)
    REFERENCES `zixin`.`user_req` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_req_company_source__company_source_id`
...
-- -----------------------------------------------------
-- Table `zixin`.`task_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `zixin`.`task_type` ;

CREATE TABLE IF NOT EXISTS `zixin`.`task_type` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `zixin`.`task` (
  ...
  `create_time` BIGINT(20) NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_task__type_id`
    FOREIGN KEY (`type_id`)
    REFERENCES `zixin`.`task_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 10000;
...
-- Table `zixin`.`data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `zixin`.`data` ;

CREATE TABLE IF NOT EXISTS `zixin`.`data` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `task_id` INT NULL,
...
-- -----------------------------------------------------
-- Data for table `zixin`.`article_type`
-- -----------------------------------------------------
START TRANSACTION;
USE `zixin`;
INSERT INTO `zixin`.`article_type` (`id`, `parent_id`, `name`) VALUES (1, NULL, '介绍');
INSERT INTO `zixin`.`article_type` (`id`, `parent_id`, `name`) VALUES (2, NULL, '新闻');
INSERT INTO `zixin`.`article_type` (`id`, `parent_id`, `name`) VALUES (3, NULL, '图片');
INSERT INTO `zixin`.`article_type` (`id`, `parent_id`, `name`) VALUES (4, NULL, '视频');

COMMIT;


-- -----------------------------------------------------
-- Data for table `zixin`.`article`
-- -----------------------------------------------------
START TRANSACTION;
USE `zixin`;
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (1, 1, NULL, '111111', NULL, NULL);
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (2, 1, NULL, '222222', NULL, NULL);
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (3, 2, NULL, '333333', NULL, NULL);
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (4, 2, NULL, '44444', NULL, NULL);
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (5, 3, NULL, '55555', NULL, NULL);
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (6, 3, NULL, '66666', NULL, NULL);
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (7, 4, NULL, '77777', NULL, NULL);
INSERT INTO `zixin`.`article` (`id`, `type_id`, `user_id`, `title`, `content`, `create_time`) VALUES (8, 4, NULL, '88888', NULL, NULL);
...
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (102, NULL, 2, '介绍', '/article?type_id=1', NULL);
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (103, NULL, 2, '新闻', '/article?type_id=2', NULL);
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (104, NULL, 2, '图片', '/article?type_id=3', NULL);
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (105, NULL, 2, '视频', '/article?type_id=4', NULL);
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (106, NULL, 2, '博客', '/article?type_id=5', NULL);
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (107, NULL, 2, '股市', '/article?type_id=6', NULL);
...
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (8, 2, 1, '文章', '/admin/article', NULL);
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (9, 5, 1, '任务类型', '/admin/task_type', NULL);
INSERT INTO `zixin`.`menu_item` (`id`, `parent_id`, `menu_id`, `name`, `href`, `icon`) VALUES (10, 5, 1, '任务', '/admin/task', NULL);
